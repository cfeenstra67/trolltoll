...
def main():
    ...
    east_provider = aws.Provider("east", profile=aws.config.profile, region="us-east-1")

    zone = aws.route53.Zone(
        "zone", name=dns_name, tags={"source": "pulumi", "project": "website"}
    )
    ...
    cloudfront_distribution = aws.cloudfront.Distribution(
        ...
        default_cache_behavior=aws.cloudfront.DistributionDefaultCacheBehaviorArgs(
            ...
            forwarded_values={"cookies": {"forward": "none"}, "query_string": False},
    ...
    root_website_record = aws.route53.Record(
        ...
        aliases=[
            {
                "name": root_bucket.website_endpoint,
